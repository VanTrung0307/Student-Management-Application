    ...
    public partial class frmSinhVien : Form
    {
        ...
        private void frmSinhVien_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //msv là mã sinh viên đang được truyền từ form dssv
                var r = new Database().Select("selectSV '"+msv+"'");
                //MessageBox.Show(r[0].ToString());//load thành công
                //set các giá tri vào component của form
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            {
                sql = "ThemMoiSV";//gọi tới produce thêm mới sinh viên
            }
            else//nếu cập nhật sinh viên
            {
                sql = "updateSV";//gọi tới produce cập nhật sinh viên
            ...
            //và danh sách cá tham số
            if(rs == 1)//nếu thực thi thành công
            {
                if (string.IsNullOrEmpty(msv))//nếu them mới
                {
