...
namespace QLSV
{
    public partial class frmDangnhap : Form
    {
        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng nhập tài khoản", "tài khoản không thể để trống");
            ...
            {
                MessageBox.Show("Vui lòng kiểm tra lại tên đăng nhập hoặc mặt khẩu","Tài khoản hoặc mật khẩu không hợp lệ");
            }
